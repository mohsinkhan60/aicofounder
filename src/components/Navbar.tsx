   ...
   return (
      <nav className="w-full">
         ...
         <div className="flex items-center space-x-2">
            <a href="/" className="flex items-center text-gray-800 text-lg font-semibold">
               <img src="/aicofounder-logo-black.svg" alt="AiCoFounder" className="h-7 w-auto" />
            </a>
         </div>

         {/* Desktop Menu */}
         <div className="hidden md:flex items-center space-x-5">
            <a href="#" className="text-[#4D4D4C] hover:text-[#B85C44] text-sm font-medium">
               Pricing
            </a>
            <a href="#" className="text-[#4D4D4C] hover:text-[#B85C44] text-sm font-medium">
               Our story
         ...
         <div
         className={`fixed top-0 right-0 w-full sm:w-[400px] h-full bg-[#f7f6f3] shadow-lg transform transition-transform duration-300 ${
         ...
         <div className="flex justify-between items-center p-4 border-b border-gray-200">
            <div className="flex items-center space-x-2">
               <div className="w-6 h-6 bg-[#c1603f] rounded-md flex items-center justify-center">
