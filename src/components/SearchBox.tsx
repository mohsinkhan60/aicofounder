    ...
    <div className="max-w-3xl w-full">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="relative">
          ...
          {showPopup && (
            <div className="hidden lg:block absolute top-full mt-2 text-[15px] -left-11 bg-charcoal-500 text-[#404040] bg-[#FAFAF7] text-xs px-3 py-2 rounded-lg shadow-lg whitespace-nowrap">
